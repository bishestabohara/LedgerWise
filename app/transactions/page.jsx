  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6 sm:mb-8">
        ...
        <div className="flex gap-2 sm:gap-3">
          <button 
            ...
            className="flex-1 sm:flex-none px-4 sm:px-5 py-2.5 bg-green-500 text-white rounded-xl text-sm font-semibold hover:bg-green-600 shadow-md shadow-green-500/20 hover:shadow-lg hover:shadow-green-500/30 transition-all duration-200"
          >
            + Add
          </button>
          <button 
            ...
            className="flex-1 sm:flex-none px-4 sm:px-5 py-2.5 bg-red-500 text-white rounded-xl text-sm font-semibold hover:bg-red-600 disabled:opacity-40 disabled:cursor-not-allowed disabled:shadow-none shadow-md shadow-red-500/20 hover:shadow-lg hover:shadow-red-500/30 transition-all duration-200"
          >
            🗑️ ({selectedTransactions.size})
          </button>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-200 mb-4 sm:mb-6">
        <div className="flex items-center bg-gray-50 rounded-xl px-3 sm:px-4 py-2.5 sm:py-3 mb-3 sm:mb-4 border border-gray-200">
          <span className="text-base sm:text-lg mr-2 sm:mr-2.5 text-gray-400">🔍</span>
          <input
            type="text"
            placeholder="Search transactions..."
            value={searchTerm}
            onChange={(e) => setSearchTerm(e.target.value)}
            className="flex-1 bg-transparent border-none outline-none text-xs sm:text-sm text-gray-900 placeholder-gray-400"
          />
        </div>
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 mb-3 sm:mb-4">
          <select
            ...
            className="flex-1 px-3 sm:px-4 py-2.5 border border-gray-200 rounded-xl text-xs sm:text-sm bg-white text-gray-900 font-medium hover:border-purple-600 focus:border-purple-600 focus:ring-2 focus:ring-purple-600/10 outline-none transition-all"
          >
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <span className="text-xs sm:text-sm text-gray-600 font-semibold whitespace-nowrap">Sort by:</span>
          <button
          ...
          filteredTransactions.map((transaction) => (
            <div key={transaction.id} className="bg-white rounded-2xl p-4 shadow-sm border border-gray-200">
              <div className="flex items-start justify-between mb-3">
                ...
                <div className={`text-lg font-bold tabular-nums ml-2 whitespace-nowrap ${
